    ...
    pd.DataFrame(
        {
            ...
            "spend_multiplier": [1.1, 1.1],
            "current_spend": [100.0, 50.0],
            "increased_spend": [110.0, 55.0],
            "current_response": [0.40, 0.25],
            "increased_response": [0.44, 0.27],
            "response_lift": [0.04, 0.02],
            "response_lift_pct": [0.10, 0.08],
        }
    ...
    pd.DataFrame(
        {
            ...
            "channel": ["search", "social"],
            "total_contribution": [1000.0, 500.0],
            "total_spend": [600.0, 400.0],
            "roi": [1.67, 1.25],
        }
...
def test_build_summary_table_describes_reports(tmp_path):
    ...
    assert summary.set_index("report").loc["spend_response", "rows"] == 2
